  ...
  return (
    <div className={`chibi-avatar chibi-${size} chibi-${state}`} style={{ width: px, height: px }}>
      <svg viewBox="0 0 32 32" width={px} height={px}>
        ...
        <ellipse cx="16" cy="10" rx="9.5" ry="10" fill={v.hair} />
        ...
        {/* Face */}
        <circle cx="16" cy="12" r="7" fill="#f5e0dc" />

        {/* Hair (front bangs — covers forehead fully) */}
        <path d="M7 9 Q10 2 16 4 Q22 2 25 9 Q22 5 16 6.5 Q10 5 7 9Z" fill={v.hair} />
          ...
          {state === 'error' ? (
            <>
              ...
              <g stroke="#45475a" strokeWidth="1.2" strokeLinecap="round">
                ...
                <line x1="13.5" y1="10" x2="11" y2="12.5" />
                <line x1="18.5" y1="10" x2="21" y2="12.5" />
                <line x1="21" y1="10" x2="18.5" y2="12.5" />
              </g>
            </>
          ) : (
            <>
              <ellipse cx="12.2" cy="11.5" rx="1.8" ry="2" fill="#313244" />
              <ellipse cx="19.8" cy="11.5" rx="1.8" ry="2" fill="#313244" />
              {/* Eye highlights */}
              <circle cx="12.8" cy="10.8" r="0.7" fill="#fff" />
              <circle cx="20.4" cy="10.8" r="0.7" fill="#fff" />
            </>
          )}
        </g>
        ...
        {/* Mouth */}
        {state === 'done' ? (
          <path d="M13.5 15 Q16 17.5 18.5 15" fill="none" stroke="#45475a" strokeWidth="0.8" strokeLinecap="round" />
        ) : state === 'error' ? (
          <path d="M13.5 16 Q16 14 18.5 16" fill="none" stroke="#45475a" strokeWidth="0.8" strokeLinecap="round" />
        ) : state === 'needs_input' ? (
          <circle cx="16" cy="15.5" rx="1.2" ry="1" fill="#45475a" />
        ) : (
          <path d="M14 15 Q16 16.5 18 15" fill="none" stroke="#45475a" strokeWidth="0.7" strokeLinecap="round" />
        )}

        {/* Blush */}
        <circle cx="10" cy="14" r="1.5" fill="#f5c2e7" opacity="0.4" />
        <circle cx="22" cy="14" r="1.5" fill="#f5c2e7" opacity="0.4" />
